...
%%     \item also tying the knot example from Atkey? example of recursion not actually tied to any datatype
%%     \end{itemize}
...
We give a denotational semantics in a presheaf model over a category
of cubes generated by two distinct interval objects with a map between
them: we use one to characterize equality, and the latter parametric
relatedness.
...
%%     irrelevance, since given $f : \forall i : \Size. T i$ we would like
...
\bibliographystyle{abbrvurl}%plainurl} %alpha}
\bibliography{intro}
